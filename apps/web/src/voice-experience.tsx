...
const voiceCopy: Record<UiLanguage, {
    ...
    en: {
        answersLabel: "Admissions answers",
        ...
        state: {
            ...
            failed: "Voice could not start. Please continue in the admissions chat.",
            handoff: "Voice has paused. An admissions manager can now review your transcript and enquiry.",
            ...
            ready: "Admissions team ready. Requesting microphone access…",
            reconnecting: "Connection interrupted. Refreshing the secure token and reconnecting…",
            warming: "Preparing your admissions conversation…",
        },
        subtitle: "Talk with the admissions team when ready",
        title: "Smart Service Admissions voice",
        transcriptEmpty: "Your transcript will appear here after you speak.",
        transcriptTitle: "Live transcript",
        voiceTitle: "An admissions manager can now review the transcript and continue with your enquiry.",
    },
    "zh-CN": {
        answersLabel: "招生咨询回答",
        continueText: "继续文字聊天",
        ...
        state: {
            ...
            ended: "语音会话已结束，未保存录音。",
            failed: "语音暂时无法启动，请继续使用文字招生咨询。",
            handoff: "语音咨询已暂停，招生经理现在可以查看您的文字记录和咨询内容。",
            idle: "点击开始语音后才会创建私密会话。",
            listening: "正在聆听，请用中文或英文提问。",
            ready: "招生团队已就绪，正在请求麦克风权限…",
            reconnecting: "连接中断，正在刷新安全令牌并重连…",
            warming: "正在准备您的招生咨询…",
        },
        subtitle: "招生团队就绪后开始咨询",
        title: "Smart Service 语音招生咨询",
        transcriptEmpty: "开始说话后，这里会显示实时文字。",
        transcriptTitle: "实时文字",
        voiceTitle: "招生经理现在可以查看文字记录并继续跟进您的咨询。",
    },
};
