...
The hosted smoke database currently contains fictional Smart Service support knowledge from three approved sources:
...
1. Sign in at `/app/knowledge` as the Smart Service Admin.
...
Expected: Smart Service conversations, sources, dashboard values, guardrails, and gaps are absent.
