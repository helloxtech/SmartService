/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e4fa44d6610e34b32774477ca801e9d)
...
interface __BaseEnv_Env {
	...
	HELLOX_FEEDBACK_INSTALLATION_KEY: "hxf_live_e239ef638778651b5e8e479ceee42b703fbbb4370d6a1a32";
	HELLOX_FEEDBACK_TURNSTILE_SITE_KEY: "0x4AAAAAAEDx-9ipx7TvTGQV";
	AUXILIARY_PROVIDER_MODE: "live";
	CHAT_ANSWER_BUDGET_MS: "8500";
	CHAT_PROVIDER_MODE: "live";
	CHAT_FALLBACK_PROVIDER: "none";
	CHAT_PRIMARY_PROVIDER: "workers-ai";
	CHAT_SUPERVISION_BUDGET_MS: "4500";
	CHAT_SUPERVISOR_PROVIDER: "workers-ai";
	CHAT_WORKERS_AI_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	CLOUDFLARE_ACCOUNT_ID: "b2dde8f02e3df92afabde46f36c6625b";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HELLOX_FEEDBACK_INSTALLATION_KEY" | "HELLOX_FEEDBACK_TURNSTILE_SITE_KEY" | "AUXILIARY_PROVIDER_MODE" | "CHAT_ANSWER_BUDGET_MS" | "CHAT_PROVIDER_MODE" | "CHAT_FALLBACK_PROVIDER" | "CHAT_PRIMARY_PROVIDER" | "CHAT_SUPERVISION_BUDGET_MS" | "CHAT_SUPERVISOR_PROVIDER" | "CHAT_WORKERS_AI_MODEL" | "CLOUDFLARE_ACCOUNT_ID" | "CRAWL_PROVIDER_MODE" | "EMBEDDING_PROVIDER_MODE" | "INGESTION_PROVIDER_MODE" | "OPENAI_EMBEDDING_DIMENSIONS" | "OPENAI_EMBEDDING_MODEL" | "OPENAI_CHAT_MODEL" | "R2_BUCKET_NAME" | "RAG_MATCH_THRESHOLD" | "TURNSTILE_PROVIDER_MODE" | "UPLOAD_PROVIDER_MODE" | "VOICE_PROVIDER_MODE" | "WORKERS_AI_GATEWAY_ID" | "LIVEKIT_AGENT_NAME" | "VERSION">> {}
}
