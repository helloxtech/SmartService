...
These files are fictional, deterministic acceptance inputs generated from the approved NovaFlow Markdown knowledge fixtures.

- `novaflow-nf-series-manual.pdf`: real eight-page, text-layer PDF.
- `novaflow-no-text.pdf`: real one-page PDF without a text layer for OCR-boundary rejection.
- `novaflow-support-faq.docx`: real DOCX with headings and list content.
