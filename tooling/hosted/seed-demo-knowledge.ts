    ...
    return [
        {
            createPayload: () => createMarkdownPayload({
                fileName: "smart-service-nf-series-manual.pdf",
                pageCount: 5,
                path: "docs/spec/fixtures/knowledge/demo_company_product_manual.md",
                sourceType: "pdf",
                title: "Smart Service NF-Series Product Manual",
            }),
            extractedObjectKey: `org/${organizationId}/hosted-fixtures/extracted/smart-service-nf-series-manual.json`,
            idempotencyKey: "hosted-dev-fixture-product-manual-v1",
            name: "smart-service-nf-series-manual.pdf",
            originalObjectKey: `org/${organizationId}/hosted-fixtures/original/smart-service-nf-series-manual.pdf`,
            pageCount: 5,
            sourceType: "pdf",
            sourceUrl: null,
        },
        {
            createPayload: () => createMarkdownPayload({
                fileName: "smart-service-support-faq.docx",
                pageCount: 3,
                path: "docs/spec/fixtures/knowledge/demo_company_faq.md",
                sourceType: "docx",
                title: "Smart Service Support FAQ",
            }),
            extractedObjectKey: `org/${organizationId}/hosted-fixtures/extracted/smart-service-support-faq.json`,
            idempotencyKey: "hosted-dev-fixture-support-faq-v1",
            name: "smart-service-support-faq.docx",
            originalObjectKey: `org/${organizationId}/hosted-fixtures/original/smart-service-support-faq.docx`,
            pageCount: 3,
            sourceType: "docx",
            sourceUrl: null,
        },
